...
export class PageDispoPage implements OnInit {
  ...
  constructor(public showPages: showPages, public cardControle: CardService, private requeToMenu: requeToMenu, public dataGet: DataService, private router: Router) {}
