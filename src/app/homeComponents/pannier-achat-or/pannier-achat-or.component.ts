...
@Component({
  ...
  templateUrl: './pannier-achat-or.component.html',
  styleUrls: ['./pannier-achat-or.component.scss'],
})
export class PannierAchatOrComponent implements OnInit, AfterViewChecked {
